...
func NewRedisRepository(redisURL string) (urlshortener.RedirectRepository, error) {
...
func (r *redisRepository) Find(code string) (*urlshortener.Redirect, error) {
...
func (r *redisRepository) Store(redirect *urlshortener.Redirect) error {
