...
type handler struct {
	redirectService urlshortener.RedirectService
}

func NewHandler(redirectService urlshortener.RedirectService) RedirectHandler {
...
func (h *handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Cause(err) == urlshortener.ErrRedirectNotFound {
...
func (h *handler) Post(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Cause(err) == urlshortener.ErrRedirectInvalid {
